...
class Backtest(object):
    def __init__(
        ...
        execution_handler, portfolio, strategy, nome_file
    ):
    ...
    def _generate_trading_instances(self):
        print(
        "Creando DataHandler, Strategy, Portfolio e ExecutionHandler..."
        )
    ...
    def output_performance(self):
                self.portfolio.create_equity_curve()

                print("Creazione delle statistiche sommarie...")
                stats = self.portfolio.output_summary_stats(nome_file)

                print("Creazione dell'equity curve...")
